...
func Render(cfg *config.Config, site *model.Site) (string, error) {
	result := []string{
...
func renderTerraformConfig(cfg *config.Config, site *model.Site) (string, error) {
...
func renderServices(cfg *config.Config, site *model.Site) (string, error) {
...
func renderComponent(cfg *config.Config, site *model.Site, component *model.SiteComponent) (string, error) {
